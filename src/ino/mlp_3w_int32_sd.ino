...
#define MULT0 1355059576
#define SHIFT0 28
#define MULT1 1967643688
#define SHIFT1 25
#define MULT2 1196893862
#define SHIFT2 26
...
void setup(){
    ...
    for(int n=0;n<N_TEST;n++){
        ...
        int32_t x[INPUT_SIZE];
        uint8_t y;

        // ---- leitura amostra ----
        unsigned long t0 = micros();
        fileX.read(x, INPUT_SIZE*4);
        fileY.read(&y,1);
